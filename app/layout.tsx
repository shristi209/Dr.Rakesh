        ...
        <header>
          <div className="fixed left-0 right-0 z-50">
            ...
            <header className="border-b bg-white py-2 md:py-4">
              <div className="container flex items-center justify-around px-2 md:px-4">
                <Link href="/" className="flex items-center gap-2">
                  ...
                  />
                  <span className=" font-semibold text-emerald-600 md:text-2xl">
                    Dr. Rakesh Yadav{" "}
                    <span className="text-[#8fa5a0]">(Orthopedic Surgeon)</span>
                  </span>
                </Link>
